...
public class ClimberSubsystem extends SubsystemBase {
  ...
  private SmartMotorController elvLeaderMotorController = new TalonFXWrapper(m_elevatorLeaderMotor, DCMotor.getFalcon500Foc(2), elevatorLeaderConfig);
  ...
  public Command setHeight(Distance height) { 
    return elevatorLeader.run(height);
  }
   ...
   */
  public Command set(double dutycycle) { return elevatorLeader.set(dutycycle);}
