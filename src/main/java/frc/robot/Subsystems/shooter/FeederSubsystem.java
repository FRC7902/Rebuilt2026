...
public class FeederSubsystem extends SubsystemBase {
  ...
  public FeederSubsystem() {
     ...
     .withControlMode(ControlMode.CLOSED_LOOP)
      ...
      .withClosedLoopController(FeederConstants.FEEDER_KP,FeederConstants.FEEDER_KI, FeederConstants.FEEDER_KD, DegreesPerSecond.of(90), DegreesPerSecondPerSecond.of(45))
      .withSimClosedLoopController(FeederConstants.FEEDER_KP, FeederConstants.FEEDER_KI,FeederConstants.FEEDER_KD, DegreesPerSecond.of(90), DegreesPerSecondPerSecond.of(45))
      // Feedforward Constants
      .withFeedforward(new SimpleMotorFeedforward(0, FeederConstants.FEEDER_KV, FeederConstants.FEEDER_KA))
      .withSimFeedforward(new SimpleMotorFeedforward(0, FeederConstants.FEEDER_KV, FeederConstants.FEEDER_KA))
      // Telemetry name and verbosity level
      .withTelemetry("FeederMotor", TelemetryVerbosity.HIGH)
      // Gearing from the motor rotor to final shaft.
      // In this example GearBox.fromReductionStages(3,4) is the same as GearBox.fromStages("3:1","4:1") which corresponds to the gearbox attached to your motor.
      // You could also use .withGearing(12) which does the same thing.
      .withGearing(FeederConstants.GEARING)
      // Motor properties to prevent over currenting.
      .withMotorInverted(false)
      .withIdleMode(MotorMode.COAST)
      .withStatorCurrentLimit(Amps.of(FeederConstants.FEEDER_STATOR));
